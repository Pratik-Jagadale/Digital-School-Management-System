...
Public Class rpt_Students_Bill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DSMS.rpt_Students_Bill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Students_Bill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Students_Bill = New rpt_Students_Bill()
        rpt.Site = Me.Site
        Return rpt
    End Function
